...
if ( ! function_exists( 'baskerville_load_javascript_files' ) ) {
	...
	function baskerville_load_javascript_files() {
		...
		if ( ! is_admin() ) {
			...
			wp_register_script( 'baskerville_mixitup', get_template_directory_uri() . '/js/mixitup.min.js', '', true );

			wp_enqueue_script( 'baskerville_global', get_template_directory_uri() . '/js/global.js', array( 'jquery', 'masonry', 'baskerville_imagesloaded', 'baskerville_flexslider', 'baskerville_mixitup' ), '', true );
